...
- [x] 릴리즈 노트 포맷: 간소화 텍스트 (Markdown 기호 제거)
...
### 기능 4: 업데이트 알림에 릴리즈 노트 표시 ✅ 구현 완료 (2026-02-26)
- [x] GitHub `/releases` API 호출 메서드 추가
- [x] 현재 버전 이후 릴리즈 필터링 및 최신순 정렬
- [x] Markdown 간소화 텍스트 변환 (StripMarkdown)
- [x] 토스트 배너에 릴리즈 노트 스크롤 영역 추가
