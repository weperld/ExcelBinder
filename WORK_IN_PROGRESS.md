...
| WIP-20260224-001 | 2026-02-24 | 신규 | 릴리즈 버전 체크 및 새 버전 다운로드 알림 | - |
| WIP-20260224-002 | 2026-02-24 | 수정 | 업데이트 알림을 플로팅 토스트로 변경 | - |
| WIP-20260224-003 | 2026-02-24 | 수정 | 닫힌 토스트 재열기 인디케이터 버튼 추가 | - |
| WIP-20260224-004 | 2026-02-24 | 수정 | 코드 리뷰 HIGH 이슈 6건 수정 | - |
| WIP-20260224-005 | 2026-02-24 | 수정 | AI Assistant 기능 전체 제거 | - |
| WIP-20260224-006 | 2026-02-24 | 수정 | Settings UI 개선 (GitHub 버튼, Live Preview 크기) | - |
| WIP-20260225-001 | 2026-02-25 | 신규 | 스키마 헤더 체크 박스 (선택적 포함/제외) | - |
